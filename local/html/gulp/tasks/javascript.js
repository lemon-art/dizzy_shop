...
gulp.task('javascript:vendor', function() {
  return gulp.src([
      ...
      // path.resolve('bower_components', 'popper.js/dist/popper.min.js'),
      // path.resolve('node_modules', 'bootstrap/dist/js/bootstrap.min.js'),
...
gulp.task('javascript:files', function() {
  return gulp.src([
    config.src.js + '/*.js'
  ])
  .pipe(plumber({ errorHandler: config.errorHandler }))
