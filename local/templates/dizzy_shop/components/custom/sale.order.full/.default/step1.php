<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	    ...
	    <div class="ui-group">
            ...
            <input class="ui-input" type="tel" name="ORDER_PROP_3" value="<?if ( $arResult["USER_PHONE"] ):?><?=$arResult["USER_PHONE"]?><?endif;?>">
        </div>
		...
		<div class="ui-group">
            ...
            <input class="ui-input" type="text" name="ORDER_PROP_7" value="">
        </div>
