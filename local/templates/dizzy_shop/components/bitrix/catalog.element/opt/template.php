...
?>
	...
	<div class="card bx-catalog-element" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
        ...
        <div class="container">
            ...
            <div class="card__nav"><a class="card__nav-back" href="<?=$arResult['NAVIGATION']['BACK_URL']?>">&lt; Назад в каталог</a>
              <ul class="card__nav-menu">
				<?if ( $arResult['NAVIGATION']['PREV_URL'] ):?>
					<li><a class="card__nav-link" href="<?=$arResult['NAVIGATION']['PREV_URL']?>">&lt;</a></li>
				<?endif;?>
                <li>
                  <div class="card__nav-link"><?=$arResult['NAVIGATION']['CURRENT_NUMBER']?></div>
                </li>
                <li>/</li>
                <li>
                  <div class="card__nav-link"><?=$arResult['NAVIGATION']['COUNT']?></div>
                </li>
				<?if ( $arResult['NAVIGATION']['NEXT_URL'] ):?>
					<li><a class="card__nav-link" href="<?=$arResult['NAVIGATION']['NEXT_URL']?>">&gt;</a></li>
				<?endif;?>
              </ul>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-5 col-lg-4">
				...
				<div class="card__size">
								...
								<div class="table-size-scroll">
									...
									<table class="table-size">
									  <thead>
										<tr>
											<th><span class="is-hide_mobile-s">Размер/цвет:</span></th>
                ...
                <div class="card__ctrl" data-entity="main-button-container">
					...
					<a class="btn btn-like <?if ( in_array($arResult['ID'], $arResult["FAVORITES"])):?>active<?endif;?>" data-id="<?=$arResult['ID']?>" href="#">
						<u class="btn-like-icon">
						  <svg class="ico ico-like">
							<use xlink:href="<?=SITE_TEMPLATE_PATH?>/img/sprite.svg#ico-like"></use>
						  </svg>
						</u>
						<?if ( in_array($arResult['ID'], $arResult["FAVORITES"])):?>
							<span>Убрать из списка<br>желаний</span>
						<?else:?>
