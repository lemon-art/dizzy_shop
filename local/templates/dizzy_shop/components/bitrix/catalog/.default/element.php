...
?>
						 ...
						 <?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"CART_PROPERTIES_5" => array("SIZES_CLOTHES", ""),
								"CONVERT_CURRENCY" => "N",
								"DEPTH" => "2",
								"DETAIL_URL" => "",
		...
		<div class="popup-dialog popup-sizes mfp-hide" id="popup-sizes">
			<div class="popup-sizes__title"><?=GetMessage('SIZES_TABLE')?></div>
			<div class="popup-sizes__content">
				<?$APPLICATION->IncludeComponent(
					"bitrix:main.include",
					"",
					Array(
