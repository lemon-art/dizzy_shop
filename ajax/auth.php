...
switch($_REQUEST['TYPE'])
{
    case "SEND_PWD":
    {
        ...
        $APPLICATION->IncludeComponent("bitrix:system.auth.forgotpasswd","modal",Array());
    }
        break;
    ...
    case "REGISTRATION":
    {
		...
		*/
        ...
        if($USER->IsAuthorized())
        {
            ...
            ?>
            <p>Дорогой <b><?=$USER->GetFullName();?>!</b></p>
            <p><span style="color: #006db8;">Вы зарегистрированы и успешно вошли на сайт!</span></p>
    ...
    default:
    {
        ...
        if($USER->IsAuthorized())
        {
            ...
            ?>
            <p>Дорогой <b><?=$USER->GetFullName();?>!</b></p>
            <p><span style="color: #006db8;">Вы успешно вошли на сайт!</span></p>
            <p>Сейчас страница автоматически перезагрузится и Вы сможете продолжить <br/>работу под своим именем.</p>
            <script>
                function TSRedirectUser(){
                    window.location.href = '<?=$backurl;?>';
