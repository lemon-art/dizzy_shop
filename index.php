...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "main_page_sections", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "main_page_adventures", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "main_page_actions"
	),
	false
);?>
	    ...
	    <div class="text">
			<div class="container">
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => SITE_DIR."include/main_page_text.php",
							"AREA_FILE_RECURSIVE" => "N",
							"EDIT_MODE" => "html",
						),
						false,
